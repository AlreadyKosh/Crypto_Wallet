class CoinsController < ApplicationController
  before_action :set_coin, only: %i[ show edit update destroy ] #Configura as moedas antes de começar (FILTRO)
  ...
  private
    ...
    def coin_params
      params.require(:coin).permit(:description, :acronym, :url_image, :mining_type_id) #Parametros Permitidos
    end
